...
export var projectOBJs = [
    {
        "id": "P1",
        "Name": "Phoenix One",
        "ProjectBackImg": "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(62, 63, 65, 1) 97%), linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(62, 63, 65, 1) 97%), url('./Images/Projects/P1/p1-6.JPG') no-repeat",
        ...
        "Accolades": "L Stands for Winner was chosen to present Phoenix One at the 2023 SXSW Games exhibition in Sydney as part of the student showcase on behalf of Macquarie University, recieving very positive feedback from other students and established industry figures.",
        "RoleAct": "For this project, I was both a developer and designer, focusing on the character's movement system and the design of the levels. The movement and the levels had to be designed in a way that complemented each other and that allowed the game to achieve the fast-paced and fluid to play. In terms of programming, I was responsible for creating the internal systems required for the player controller, making use of Unity's physics system to create a force-based approach. I spent a lot of time refining each compontent of the player's moveset so that it felt quick and responsive, such as the left-right movement having very little acceleration and decelleration times to allow for quick direction changes, and little-to-no end-lag being implemented on the character's moveset so multiple movement options could be chained together. On Level design, to fit with our design philosophy of fast and fluid movement combined with aspects of critical thinking, I ensured that the levels contained terrain features that would encourage the player to combine their movement and ballistics to solve each enemy encounter, such as using the terrain geometry to set up a certain shot, or dashing to another position to get an enemy to face you and expose its rear to an oncoming projectile.",
    ...
    },
    {
        ...
        "ProjectBackImg": "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 1) 97%), linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(0, 0, 0, 1) 97%), url('./Images/Projects/BSC/bsc-5.JPG') no-repeat",
    ...
    },
    {
        "id": "SPC",
        "Name": "Personal Space",
        "ProjectBackImg": "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(10, 6, 20, 1) 97%), linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(10, 6, 20, 1) 97%), url('./Images/Projects/SPC/spc-3.JPG') no-repeat",
        "Developers": "https://lstandsforwinner.studio/",
        "StudioLogo": "LSW-Logo.png",
        "StudioBackground": "rgba(0, 0, 0, 1)",
        ...
        "Accolades": "This project was produced for MQ Game Jams, a 48-Game Jam with the theme of Re-Entry. It won the people's choice award, and would then go on to be chosen to be displayed at Macquarie University's annual astrononmy night as part of their interactives exhibition.",
    ...
    },
    {
        ...
        "ProjectBackImg": "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(61, 45, 29, 1) 97%), linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(61, 45, 29, 1) 97%), url('./Images/Projects/ANT/ant-3.JPG') no-repeat",
        "Developers": "https://lstandsforwinner.studio/",
        "StudioLogo": "LSW-Logo.png",
        "StudioBackground": "rgba(0, 0, 0, 1)",
        ...
        "Accolades": "This project was produced for the GMTK Game Jam, a 4-day Game Jam with the theme of Built to Scale.",
        "RoleAct": "My role for this game-jam project was 3D artist. Due to the theme of this game jam being 'Built to Scale', and so we decided to make a game from the perspective of an ant, hence making the scale of the in-game environment very small. Naturally this meant designing and modelling the 3D objects to match how they might appear to something or someone of that size, with tall and imposing profiles, exaggerated detail, etc.",
    ...
    },
    {
        "id": "BSM",
        "Name": "Basement Game",
        "ProjectBackImg": "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(77, 82, 88, 1) 97%), linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(77, 82, 88, 1) 97%), url('./Images/Projects/BSM/bsm-5.JPG') no-repeat",
        "Developers": "https://lstandsforwinner.studio/",
        "StudioLogo": "LSW-Logo.png",
        "StudioBackground": "rgba(0, 0, 0, 1)",
        "Release": "Released: 2023",
        ...
        "Accolades": "This project was produced for the 15th Pirate Software Game Jam, a 14-day Game Jam with the themes of Alchemy and Shadows.",
    ...
    },
    {
        ...
        "ProjectBackImg": "linear-gradient(to bottom, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(255, 255, 255, 1) 97%), linear-gradient(to right, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0) 59%, rgba(255, 255, 255, 1) 97%), url('./Images/Projects/PLN/ttrtitle.webp') no-repeat",
